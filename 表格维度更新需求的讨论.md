...
首先，在用户上传表格类型附件的时候，会计算该表表头的哈希值，存储在数据库中（数据库表也增加相应字段）。
...
<img width="1000" height="800" alt="原需求流程图" src="https://github.com/user-attachments/assets/bdfc4c27-a641-4af4-98e2-12331ca6ecf9"/>

后续对于这个需求的实现我觉得我们需要再讨论一下。。。
